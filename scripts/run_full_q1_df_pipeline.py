...
def main():
    ...
    last_path = get_last_output_path("q1_df_")
    ...
    run_command(
        f"docker exec namenode bash -c \"hdfs dfs -getmerge {last_path} /results/q1_df_result.csv && "
        f"echo '✅ File CSV pronto in /results/q1_df_result.csv'\""
    )

    print("📁 File CSV disponibile nella directory 'Results':")
    print("  - Results/csv/q1_df_result.csv")
